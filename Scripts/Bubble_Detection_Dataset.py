...
input_directory = r"C:\Users\juanp\Desktop\Research project\TEST3\0.8\Images"
output_directory = r"C:\Users\juanp\Desktop\Research project\TEST3\0.8\Diameters"
# Create the output directory if it doesn't exist
os.makedirs(output_directory, exist_ok=True)

# Loop over each image file in the input directory
for filename in os.listdir(input_directory):
    # Process only image files (adjust the extensions as needed)
    if filename.lower().endswith(('.jpg')):
        ...
        for region in props:
            ...
            diameter = 2 * np.sqrt(real_area/np.pi) * 10 #mm
        ...
        save_path = os.path.join(output_directory, txt_filename)
